...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[344px] w-[344px] md:h-[500px] md:w-[500px] border border-white opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
